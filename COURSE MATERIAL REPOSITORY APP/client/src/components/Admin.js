  ...
  return (
    ...
    color: #444
      ...
      <ul>       
        ...
        <li onClick={openStudent2Modal} > <img src ='/students.png' alt =''/> &nbsp; <span> Student</span></li>  
        <li  onClick={openLecturer2Modal} > <img src ='/teachers.png' alt =''/> &nbsp; <span>Lecturer</span></li>
        <li onClick={openCourses} > <img src ='/schools.png' alt =''/> &nbsp; <span>Courses</span></li>
         <li onClick={openSignupModal} > <img src ='/teachers.png' alt =''/> &nbsp;<span>Add Lecturer</span> </li> 
         <li onClick={openSignupModal} > <img src ='/students.png' alt =''/> &nbsp; <span>Add Student</span></li> 
        <li  onClick={openEnrollModal} > <img src ='/students.png' alt =''/> &nbsp;<span>Enroll Student</span> </li>        
      </ul>      
  </div>
