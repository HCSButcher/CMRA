    ...
    color: #444
      ...
      <div className="container">
        ...
        <div className="content">
          ...
          <div className="content-2">
            <div className="lecturers">
              <div className="title">
                <h2>Lecturers</h2>
                <a href="/lecturers" className="btn">
                  {' '}
                  view All{' '}
                </a>
              </div>
        ...
        {showEnrollModal && (
          <div className="modal">
            <div className="modal-content">
              <span className="close" onClick={closeEnrollModal}>
                {' '}
                &times;
              </span>
        ...
        {showCourses && (
          <div className="modal">
            <div className="modal-content">
              <span className="close" onClick={CloseCourses}>
                {' '}
                &times;
              </span>
        ...
        {showLecturer2Modal && (
          <div className="modal">
            <div className="modal-content">
              <span className="close" onClick={CloseLecturer2Modal}>
                {' '}
                &times;{' '}
              </span>
              <Lecturer2Modal
                isOpen={showLecturer2Modal}
                onClose={CloseLecturer2Modal}
              />
            </div>
          </div>
        )}
        ...
        {showStudent2Modal && (
          <div className="modal">
            <div className="modal-content">
              <span className="close" onClick={CloseStudent2Modal}>
                {' '}
                &times;{' '}
              </span>
              <Student2Modal
                isOpen={showStudent2Modal}
                onClose={CloseStudent2Modal}
              />
            </div>
          </div>
        )}
