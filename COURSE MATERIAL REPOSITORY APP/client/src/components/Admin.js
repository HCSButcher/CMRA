...
const LecturerDelete = (id) => {
  axios
    .delete(`http://192.168.101.100:3001/getLecturers/${id}`) 
    .then(() => {
...
const StudentDelete = (id) => {
  axios
    .delete(`http://192.168.101.100:3001/getStudents/${id}`) 
    .then(() => {
...
useEffect(() => {
  ...
  axios
    .get("http://192.168.101.100:3001/countStudents", {
      headers: {
...
useEffect(() => {
  ...
  axios
    .get("http://192.168.101.100:3001/countLecturers", {
      headers: {
...
useEffect(() => {
  ...
  axios
    .get("http://192.168.101.100:3001/countSchool", {
      headers: {
        Authorization: `Bearer ${token}`, // Attach the Authorization token
      },
    })
...
useEffect(() => {
  ...
  axios
    .get("http://192.168.101.100:3001/countCourses", {
      headers: {
  ...
  return (
    ...
    color: #444
      ...
      <ul>       
        ...
        <li onClick={openStudent2Modal} > <img src ='http://192.168.101.100:3000/students.png' alt =''/> &nbsp; <span> Student</span></li>  
        <li  onClick={openLecturer2Modal} > <img src ='http://192.168.101.100:3000/teachers.png' alt =''/> &nbsp; <span>Lecturer</span></li>
        <li onClick={openCourses} > <img src ='http://192.168.101.100:3000/schools.png' alt =''/> &nbsp; <span>Courses</span></li>
         <li onClick={openSignupModal} > <img src ='http://192.168.101.100:3000/teachers.png' alt =''/> &nbsp;<span>Add Lecturer</span> </li> 
         <li onClick={openSignupModal} > <img src ='http://192.168.101.100:3000/students.png' alt =''/> &nbsp; <span>Add Student</span></li> 
        <li  onClick={openEnrollModal} > <img src ='http://192.168.101.100:3000/students.png' alt =''/> &nbsp;<span>Enroll Student</span> </li>        
      </ul>      
  </div>
  ...
  <div className="content">
    <div className="cards">
      <div className="card">
        ...
        <img src ='http://192.168.101.100:3000/students.png' alt =''/>
        </div>
      </div>
      <div className="card">
        <div className="box">
        ...
        <div className="icon-case">
        <img src ='http://192.168.101.100:3000/teachers.png' alt =''/>
        </div>
      </div>
      <div className="card">
        <div className="box">
        ...
        <div className="icon-case">
        <img src ='http://192.168.101.100:3000/schools.png' alt =''/>
        </div>
      </div>
      <div className="card">
        <div className="box">
